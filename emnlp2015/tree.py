...
#copied on 10 October 2012 from
#https://github.com/kmike/nltk/blob/2and3/nltk/compat.py
#https://github.com/kmike/nltk/blob/2and3/nltk/tree.py
#stripped of all NLTK dependencies to make the module stand-alone

#on 29 November 2013: use square brackets by default
